...
grouped = df.groupby(['Scheme', 'NodeNum'])['ops'].agg(['mean', 'std'])
...
minor_yticks = np.arange(0.5, 7, 0.5)
...
l = ax.legend(labels= label[:5], loc='center left', ncols= 2, bbox_to_anchor=(0.1, 0.82), fontsize=36, reverse=False, labelspacing=0.3, columnspacing=0.5, frameon=False, handlelength=1, handleheight=1.3, markerscale=0.8, handletextpad=0.3)
