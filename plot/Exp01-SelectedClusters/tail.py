...
grouped = df.groupby(['Scheme', 'tNum'])['p95'].agg(['mean', 'std'])
...
ax.set_ylim(0, 1.09)
ax.set_yticks(np.arange(0,1.1,0.2),labels = ['0', '0.2', '0.4', '0.6', '0.8', '1'])

minor_yticks = np.arange(0.1, 1, 0.2)
...
ax.set_ylabel("95th latency (ms)", fontsize=42)
